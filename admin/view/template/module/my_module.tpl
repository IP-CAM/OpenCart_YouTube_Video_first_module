      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table id="module" class="list">
          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
            <td class="left"><input type="text" name="my_module_module[<?php echo $module_row; ?>][link]" value="<?php echo $module['link']; ?>" size="50" /></td>
              ...
              <td class="left"><input type="text" name="my_module_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
...
function addModule() {	
	...
	html += '  <tr>';
    html += '    <td class="left"><input type="text" name="my_module_module[' + module_row + '][link]" value="" size="50" /></td>';
